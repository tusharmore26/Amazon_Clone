  ...
  return (
    <div className='w-full sticky top-0 z-50'>
      <div className='w-full bg-amazon_blue text-white px-4 py-3 flex items-center gap-4'>
        ...
        bg-gray-200 hover:bg-gray-300 border-2 cursor-point duration-300 text-sm ☐ text-amazon_blue font-titleFont flex items-center
        ...
        <div className='flex flex-col items-start justify-center headerHover'>
          ...
          <p className='text-sm font-semibold -mt-1 text-whiteText  mdl:inline-flex'>Accounts & Lists <span><ArrowDropDownOutlinedIcon></ArrowDropDownOutlinedIcon></span></p>
        </div>
        </Link>
