...
const handlePassword=(e)=>{
 ...
 const handleLogin = (e) =>{ 
  ...
  .then((userCredential) => {
    ...
    // ...
    setLoading(false)
    setSuccessMsg("Logged in Successfully! Welcom you back!")
    setTimeout(() => {
      navigate("/")
    },2000);
  })
    ...
    <div className='w-full'>
        ...
        <br></br>
      {
        successMsg ? <div className='w-full flex justify-center items-center py-32'>
          <p className='border-[1px] border-gray-600 text-green-500 font-titleFont text-lg font-semibold px-6 py-2'>{successMsg}</p>
        ...
        <div className='w-full border border-zinc-200 p-6'>
          ...
          <div className='flex flex-col '>
            ...
            <div className='flex flex-col gap-2'>
              ...
              <input onChange={handlePassword} value={password} className='w-full lowercase py-1 border border-zinc-400 px-2 text-base rounded-sm outline-none focus-within:border-[#e77600] focus-within:shadow-amazonInput duration-100' type='password '></input>
              {
                        errPassword && (
                            <p className='text-red-600 text-xs font-semibold tracking-wide flex items-center gap-2 -mt-1.5'>
